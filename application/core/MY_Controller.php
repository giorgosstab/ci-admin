...
class MY_Controller extends CI_Controller
{
  ...
  function __construct() {
    ...
    } elseif(isset($_SESSION['set_language'])){   // If not, we look to see if the language session variable is set
      $this->current_lang = $_SESSION['set_language'];
    } else { // If not, we set the language session to the default language
